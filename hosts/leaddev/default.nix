{ config, modulesPath, pkgs, name, host, ... }:
{
  ...
  networking = { hostName = "leaddev"; enableIPv6 = false; dhcpcd.enable = false; useDHCP = false; useHostResolvConf = false; };
  ...
  services.openclaw = {
    ...
    availableModels = [
      ...
      # OpenAI (direct)
      "openai/gpt-4o"
      # OpenRouter — coding-focused
      "openrouter/mistralai/codestral-2501"
      "openrouter/google/gemini-2.5-flash-lite"
      "openrouter/meta-llama/llama-4-scout"
    ];
    modelAliases = {
      "anthropic/claude-sonnet-4-6"              = "sonnet";          # Default — code review, architecture
      "anthropic/claude-opus-4-6"                = "opus";            # Deep design, security analysis
      "anthropic/claude-haiku-4-5"               = "haiku";           # Fast mechanical tasks
      "openai/gpt-4o"                            = "gpt-4o";          # OpenAI flagship
      "openrouter/mistralai/codestral-2501"      = "codestral";       # Coding specialist
