{ config, modulesPath, pkgs, name, host, ... }:
{
  ...
  sops.secrets.anthropic_api_key   = { sopsFile = "/etc/nixos/secrets/${host}/dutch.yaml"; key = "anthropic_api_key"; };
  sops.secrets.openai_api_key      = { sopsFile = "/etc/nixos/secrets/${host}/dutch.yaml"; key = "openai_api_key"; };
  sops.secrets.google_ai_api_key   = { sopsFile = "/etc/nixos/secrets/${host}/dutch.yaml"; key = "google_ai_api_key"; };
  sops.secrets.groq_api_key        = { sopsFile = "/etc/nixos/secrets/${host}/dutch.yaml"; key = "groq_api_key"; };
  sops.secrets.openrouter_api_key  = { sopsFile = "/etc/nixos/secrets/${host}/dutch.yaml"; key = "openrouter_api_key"; };
  services.openclaw = {
